        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AracSorunu = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Admin", true, new DateTime(2023, 4, 9, 10, 31, 19, 901, DateTimeKind.Local).AddTicks(6879), "admin@otoservissatis.tc", "admin", 1, "123456", "admin", "0850" });
